	...
	$(function(){
		...
		$("#saveClueRemarkBtn").on("click",function () {
			...
			$.ajax({
				...
				tpye:"post",
				data:{"remark":$remark,"clueId":clueId},
				dataType:"json",
			...
			success:function (data) {
				...
				$.each(data,function (k,v) {
					...
					html += '<font color="gray">线索</font> <font color="gray">-</font> <b>'+"${clue.fullname}${clue.appellation}-${clue.company}"+'</b> ' +
							'<small style="color: gray;"> '+v.createTime+' 由'+v.createBy+''+(v.editFlag==0?"创建":"修改")+'</small>';
					html += '<div style="position: relative; left: 500px; top: -30px; height: 30px; width: 100px; display: none;">';
					html += '<a class="myHref" href="javascript:void(0);" onclick="openEditRemark(\''+v.id+'\')"><span class="glyphicon glyphicon-edit" style="font-size: 20px; color: pink;"></span></a>';
					html += '&nbsp;&nbsp;&nbsp;&nbsp;';
					html += '<a class="myHref" href="javascript:void(0);" onclick="deleteClueRemark(\''+v.id+'\')"><span class="glyphicon glyphicon-remove" style="font-size: 20px; color: pink;"></span></a>';
					html += '</div>';
					html += '</div>';
					html += '</div>';
					html += '</div>';
